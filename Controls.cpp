...
void CSlider::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y + 5, Location, 9, Color(37, 137, 255, 255), Color(0, 83, 148, 255)); //Fixen
	...
	Render::Text(a.x + (m_iWidth / 2) - txtSize.right / 2, a.y + 10, Color(200, 200, 200, 255), Render::Fonts::MenuBold, buffer); //Value Farbe (weiﬂ)
}
...
void CKeyBind::Draw(bool hover)
{
	...
	Render::GradientV(a.x, a.y, m_iWidth, m_iHeight, Color(30, 30, 30, 200), Color(40, 40, 40, 200));
	if (hover)
