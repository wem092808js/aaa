...
void R::Resolve()
{
	...
	for (int i = 0; i < Interfaces::Engine->GetMaxClients(); ++i)
	{
		...
		if (Menu::Window.RageBotTab.AccuracyResolver.GetIndex() == 1 || Menu::Window.RageBotTab.AccuracyResolver.GetIndex() == 2 || Menu::Window.RageBotTab.AccuracyResolver.GetIndex() == 3 || Menu::Window.RageBotTab.AccuracyResolver.GetIndex() == 4)
		{
			...
			else
			{
				...
				if (Menu::Window.RageBotTab.AccuracyResolver.GetIndex() == 3 && eyeAngles->y != pEntity->GetLowerBodyYaw())
				{
					...
					if (Menu::Window.RageBotTab.AccuracyResolver.GetIndex() == 4 && eyeAngles->y != pEntity->GetLowerBodyYaw())
					{
						int num = Globals::Shots % 9; //geht die 9 cases durch also: case 0 -> case 8 == 9 cases
						switch (num) {
